        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center lg:text-left animate-slide-in">
            <h1 className="text-4xl lg:text-6xl font-bold mb-4">
              <span className="gradient-text">{profile.name.split(' ')[0]} {profile.name.split(' ')[1]}</span>
              <br />
              <span className="text-portfolio-text">{profile.name.split(' ').slice(2).join(' ')}</span>
            </h1>
            
            <div className="flex items-center justify-center lg:justify-start gap-2 mb-6">
              <MapPin size={20} className="text-portfolio-accent" />
              <span className="text-portfolio-muted">{profile.location}</span>
            </div>
