...
const SERVICE_ID = (import.meta.env.VITE_EMAILJS_SERVICE_ID as string) || (import.meta.env.EMAILJS_SERVICE_ID as string);
const TEMPLATE_ID = (import.meta.env.VITE_EMAILJS_TEMPLATE_ID as string) || (import.meta.env.EMAILJS_TEMPLATE_ID as string);
const TEMPLATE_ID_PENGIRIM = (import.meta.env.VITE_EMAILJS_TEMPLATE_ID_PENGIRIM as string) || (import.meta.env.EMAILJS_TEMPLATE_ID_PENGIRIM as string);
const USER_ID = (import.meta.env.VITE_EMAILJS_USER_ID as string) || (import.meta.env.EMAILJS_USER_ID as string);
const CONTACT_EMAIL = (import.meta.env.VITE_CONTACT_EMAIL as string) || (import.meta.env.CONTACT_EMAIL as string);
